...
class Screen(metaclass=Singleton):
    ...
    def _repr_svg_(self):
        return SVG.ET.tostring(self._old_svg_scene, encoding='utf8', method='xml')
    ...
    def save(self, file):
        ...
        html = SVG.ET.tostring(self._old_svg_scene, encoding='utf8', method='xml')
    ...
    def bgcolor(self, color=None):
        ...
        if self._animate:
            ...
            an.set('begin', self.animation_frame_id(self.frame_index - 1) + ".end")
            appendTo(rect, an)
        ...
        if drawing:
            ...
            if width > 2:
                if self._animate:
                    ...
                    _line.set('stroke-linecap', 'round')
    ...
    def _setup_canvas(self):
        ...
        self.svg_scene = SVG.svg(width=self.width, height=self.height,
                                 ...
                                 viewBox="0 0 {} {}".format(
                                     self.width, self.height), style={"background-color": "#fff"})
    ...
    def pen(self, pen=None, **pendict):
        ...
        if "pencolor" in p:
            ...
            if self.screen._animate:
                ...
                self.svg.set("stroke", self._pencolor)
        if "pensize" in p:
        ...
        if "fillcolor" in p:
            ...
            if self.screen._animate:
                ...
                self.svg.set("fill", self._fillcolor)
        if "speed" in p:
            self._speed = p["speed"]
        if "shown" in p:
            ...
            if self.screen._animate:
                ...
                self.svg.set('opacity', str(opacity))
...
class Turtle(TPen, TNavigator):
    ...
    def _make_copy(self, name=None):
        ...
        _turtle.set("opacity", str(0 if self.screen._animate else 1))
        _turtle.set("fill", self._fillcolor)
        _turtle.set("stroke", self._pencolor)
        ...
        if self.screen._animate:
            ...
            _turtle.set("transform",
                                 f"translate({x}, {y}) "
                                 f"rotate({self._old_heading}, 0, 0)")
            _turtle.set("opacity", "1")
        return _turtle
